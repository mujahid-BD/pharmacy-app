        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="mb-6">
              ...
              <p className="text-center text-black dark:text-gray-100">ফার্মেসির নাম: {pharmacyInfo.name}</p>
              <p className="text-center text-black dark:text-gray-100">লাইসেন্স নম্বর: {pharmacyInfo.license}</p>
              <p className="text-center text-black dark:text-gray-100">ঠিকানা: {pharmacyInfo.address}</p>
              <p className="text-center text-black dark:text-gray-100">ফোন: {pharmacyInfo.phone}</p>
              <p className="text-center text-black dark:text-gray-100">ইমেইল: {pharmacyInfo.email}</p>
            </div>
            <div className="mb-6">
              <input
                type="text"
